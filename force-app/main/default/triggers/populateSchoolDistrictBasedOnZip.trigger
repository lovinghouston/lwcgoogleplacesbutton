...
// Potential idea: Make it into a package, takes inputs of record types and fields to match on as well as Objects to match against based on settings
// Take two zip codes, do closeness matching, and an action based on that match
